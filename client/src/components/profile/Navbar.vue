								...
								<ul class="navbar-nav ml-auto py-4 py-md-0">
									<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-5">
										...
										<div class="dropdown-menu">
											<!-- <router-link class="dropdown-item" to="/home/user_profile">My profile</router-link>
											<router-link class="dropdown-item" to="/home/edit_user_profile">Edit profile</router-link> -->
											<router-link class="dropdown-item" to="/home/register_user_profile">Register admin</router-link>
										</div>
									</li>
									<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-5">
										<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Lecturer</a>
										<div class="dropdown-menu">
											<router-link class="dropdown-item" to="/home/internal_lecturer">Adviser</router-link>
											<!-- <router-link class="dropdown-item" to="/home/external_lecturer">External Lecturer</router-link> -->
										</div>
									</li>
									<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-5">
										<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Manage</a>
										<div class="dropdown-menu">
											<router-link class="dropdown-item" to="/home/course">Course</router-link>
